...
int main()
{
	...
	//cerr << s3 << endl;
	cin >> n1 >> n2;
	string buff_1 =  a.str_pow_int_2(n1, n2);
	string buff_2 =  a.str_pow_int_2(n2, n1);
	string result = a.str_mines(buff_1, buff_2);
	cout << (a.min_sign(buff_1, buff_2)?"":"-") << result << endl;
